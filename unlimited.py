        ...
        try:
            ...
            asyncio.run_coroutine_threadsafe(
                context.bot.send_message(
                    ...
                    text=f"❌ *Attack Error on VPS {ip_vps}*\n"
                         f"Error: {str(e)}\n"
                         f"Target: {ip}:{port}",
                    parse_mode='Markdown'
                ),
